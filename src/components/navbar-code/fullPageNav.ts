export const fullPageNavTs = `"use client";
...
const FullPageNav = () => {
  ...
  return (
    <>
      ...
      <motion.nav
        className="z-60 relative w-full transition-colors duration-300  dark:text-white text-black"
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 md:px-12 ">
          ...
          <div className="hidden md:flex flex-col items-center text-sm">
           <span className={\`\${roch.className} font-medium transition-colors duration-300 dark:text-gray-300  text-gray-600 \`}>
                Location•
            </span>
          ...
          >
            <div className="flex h-full">
              ...
              <div className="flex-1 flex flex-col justify-center w-full">
                {/* Company Info - Top of navigation overlay */}
                <motion.div
                ...
                >
                  <div>
                    <Link href:"/" className="text-4xl font-bold">Name</Link>
                  </div>
...
`;
export const fullPageNavJs = `"use client";
