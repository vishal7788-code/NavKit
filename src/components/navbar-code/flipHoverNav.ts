...
const FlipHoverNav = () => {
        ...
        sections: [
          {
            title: "NavKIT",
            items: [
              { name: "Add your Name", desc: " Add your description", href:"/" },
              {
                name: "Add your Name",
                href:"/",
          ...
          {content.sections.map((section: HoverSection, idx: number) => (
            <div key={idx}>
              ...
              <div className="grid grid-cols-2 gap-6">
                {section.items.map((item: HoverItem, itemIdx: number) => (
                  <div key={itemIdx} className="group cursor-pointer">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <Link href:{item.href} className="font-semibold text-gray-800 group-hover:text-gray-950 transition-colors">
                          {item.name}
                        </Link>
  ...
  return (
    <motion.nav 
    className="dark:bg-neutral-900 bg-gray-200  rounded-3xl py-4 fixed top-0 z-40">
