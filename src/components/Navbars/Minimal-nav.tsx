...
export function MinimalNav() {
  ...
  return (
    <motion.div
      ...
      className={`${inter.className} dark:bg-neutral-900 bg-gray-200 h-auto p-4 rounded-3xl`}
    >
      ...
      <motion.nav
        ...
        transition={{ duration: 0.4, ease: "easeOut" }}
        className=" w-full max-w-7xl top-1/6 backdrop-blur-lg bg-background/60 border rounded-lg supports-[backdrop-filter]:bg-background/60 shadow-md"
      >
